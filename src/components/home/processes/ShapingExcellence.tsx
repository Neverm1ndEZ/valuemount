  ...
  return (
    <section className=''>
      <div className='flex justify-between items-center w-full'>
        ...
        <div>
          <Image src={'/four.gif'} alt={'page number'} width={250} height={250} unoptimized />
        </div>
      </div>
      <div className='flex items-start justify-between w-full gap-x-6'>
        <div className=''>
          <Image src={'/se.svg'} alt='Shaping Excellence' width={480} height={510} />
        </div>
        <div className='grid justify-between h-full pt-4'>
          <div className='space-y-4'>
            <h1 className='text-[#AD8330] text-4xl font-bold'>Shaping Excellence</h1>
            <h2 className='text-xl text-[#000] font-bold'>Custom solutions tailored to your needs.</h2>
